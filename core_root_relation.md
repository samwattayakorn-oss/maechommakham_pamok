...
├── Core_Root_Relation_Path.md
├── Core_Root_Relation_Direction.md
├── Core_Root_Relation_Strength.md
├── Core_Root_Relation_Dependency.md
├── Core_Root_Relation_Priority.md
├── Core_Root_Relation_State.md
├── Core_Root_Relation_Status.md
├── Core_Root_Relation_Value.md
├── Core_Root_Relation_Condition.md
├── Core_Root_Relation_Rule.md
├── Core_Root_Relation_Reference.md
